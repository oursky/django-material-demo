...
class BaseCompositeField(object):
    ...
    initial = None  # HACK: Don't know what is the logic like for initial value
...
class ForeignKeyFormField(ModelFormField):
    def __init__(
        ...
        super(ForeignKeyFormField, self).__init__(
            form_class, kwargs, **field_kwargs)
...
class FormSetField(CompositeField):
    ...
    def __init__(self, formset_class, add_more_label=None, kwargs=None, **field_kwargs):
        ...
        if kwargs is None:
            kwargs = {}
        self.default_kwargs = kwargs
        self.add_more_label = add_more_label
    ...
    def get_formset(self, form, name):
        ...
        formset = formset_class(
            ...
            form_kwargs={
                ...
                "get_formset": lambda: formset,
                **self.form_kwargs,
            },
            **kwargs
        )
        formset.parent_instance = instance
        formset.add_more_label = self.add_more_label
        return formset
