...
/* global $, Turbolinks */
var Formset = /*#__PURE__*/function (_HTMLElement) {
  _inherits(Formset, _HTMLElement);

  var _super = _createSuper(Formset);
  ...
  _createClass(Formset, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      $(this).find(".formset-field").formset({
        animateForms: !0
      });
    }
  }]);
...
window.addEventListener('load', function () {
  window.customElements.define('dmc-formset', Formset);
});
"use strict";
  ...
  _createClass(Snackbar, [{
    ...
    value: function connectedCallback() {
      ...
      var _loop = function _loop(i) {
        setTimeout(function () {
          M.toast({
            html: _this2.children[i].innerHTML,
            displayLength: 10000,
            classes: _this2.children[i].className
          });
        });
      };
